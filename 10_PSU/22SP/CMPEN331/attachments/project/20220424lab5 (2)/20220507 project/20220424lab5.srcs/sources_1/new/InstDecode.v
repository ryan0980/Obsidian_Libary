...
Control c(dinstOut[31:26], dinstOut[5:0], dinstOut[25:21], dinstOut[20:16], mdestReg, mm2Reg, mwreg, edestReg, em2Reg, ewreg, RsrtEqu,    
     wreg, wm2reg, wwmem, waluc, waluimm, wrtMUX, fwd_A, fwd_B, wpcir, jal, shift, sext, pcsrc);             
